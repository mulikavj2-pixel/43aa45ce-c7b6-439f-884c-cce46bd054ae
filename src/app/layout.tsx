...
export const metadata: Metadata = {
  title: "TechFlow | IT Solutions & Software Development",
  description: "Transform your business with innovative IT solutions, cloud infrastructure, AI & ML development, and custom software. Expert engineering team ready to scale your vision.",
  keywords: "IT startup, software development, cloud solutions, AI development, custom software, DevOps, enterprise solutions",
  metadataBase: new URL("https://techflow.io"),
  alternates: {
    canonical: "https://techflow.io"
  },
  openGraph: {
    title: "TechFlow | Innovation Meets Execution",
    description: "Build the future with cutting-edge technology solutions designed for modern businesses.",
    url: "https://techflow.io",
    siteName: "TechFlow",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765798261211-y3cuynsv.jpg",
  ...
  twitter: {
    ...
    title: "TechFlow | IT Solutions & Software Development",
    description: "Transform your business with innovative IT solutions and expert engineering.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1765798261211-y3cuynsv.jpg"]
  },
  robots: {
    index: true,
    follow: true
